import { requestOptionsGet, UrlGetRekapCitasiPublikasiPertahunByProdi, UrlGetRekapCitasiPublikasiPertahunByJenisByProdi } from "../controller/template.js";

// Conditional Jika D4 TI atau Bukan
...
document.addEventListener("DOMContentLoaded", function() {
    fetch(UrlGetRekapCitasiPublikasiPertahunByProdi + '?kode_prodi=14', requestOptionsGet)
...
document.addEventListener("DOMContentLoaded", function() {
    fetch(UrlGetRekapCitasiPublikasiPertahunByJenisByProdi + '?kode_prodi=14', requestOptionsGet)
        .then(response => response.json())
        .then(data => {
            const datasets = {};
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function getDataFromAPI(id) {
        fetch(UrlGetRekapCitasiPublikasiPertahunByProdi + `?kode_prodi=${id}`, requestOptionsGet)
        .then(response => response.json())
        .then(data => {
